...
export const ANIMALS: Animal[] = [
  ...
  // ===========================================================================
  // Adições (revisadas via busca web): répteis, aves, peixe elétrico, pets e mustelídeos
  // ===========================================================================
  {
    id: "cascavel",
    nomeComum: "Cascavel",
    ...
    campos: {
      reino: "Animalia", grupo: "Réptil", simetria: "Bilateral",
      // Viperídeos (Crotalus) são vivíparos.
      reproducao: "Vivíparo", fecundacao: "Interna", desenvolvimento: "Direto",
      habitat: "Terrestre", dieta: "Carnívoro", zoonose: "Não", relevancia: "Silvestre",
      termorregulacao: "Ectotérmico", revestimento: "Escamas", respiracao: "Pulmonar",
      esqueleto: "Endoesqueleto ósseo", excrecao: "Uricotélico",
      conservacao: "LC", massaKg: 3,
    },
  },
  {
    id: "tartaruga-cabecuda",
    nomeComum: "Tartaruga-cabeçuda",
    nomeCientifico: "Caretta caretta",
    emoji: "🐢",
    revisado: true,
    taxonomia: tax("Chordata", "Reptilia", "Testudines", "Cheloniidae"),
    campos: {
      ...
      termorregulacao: "Ectotérmico", revestimento: "Escamas", respiracao: "Pulmonar",
      esqueleto: "Endoesqueleto ósseo", excrecao: "Uricotélico",
      conservacao: "VU", massaKg: 120,
    },
  },
  {
    id: "tartaruga-de-pente",
    nomeComum: "Tartaruga-de-pente",
    ...
    campos: {
      ...
      termorregulacao: "Ectotérmico", revestimento: "Escamas", respiracao: "Pulmonar",
      esqueleto: "Endoesqueleto ósseo", excrecao: "Uricotélico",
      conservacao: "CR", massaKg: 60,
    },
  },
  {
    id: "tracaja",
    nomeComum: "Tracajá",
    nomeCientifico: "Podocnemis unifilis",
    emoji: "🐢",
    revisado: true,
    taxonomia: tax("Chordata", "Reptilia", "Testudines", "Podocnemididae"),
    campos: {
      reino: "Animalia", grupo: "Réptil", simetria: "Bilateral",
      reproducao: "Ovíparo", fecundacao: "Interna", desenvolvimento: "Direto",
      habitat: "Aquático (dulcícola)", dieta: "Onívoro", zoonose: "Não", relevancia: "Silvestre",
      termorregulacao: "Ectotérmico", revestimento: "Escamas", respiracao: "Pulmonar",
      esqueleto: "Endoesqueleto ósseo", excrecao: "Uricotélico",
      conservacao: "VU", massaKg: 5,
    },
  },
  {
    id: "alma-de-gato",
    ...
    emoji: "🐦",
    revisado: true,
    taxonomia: tax("Chordata", "Aves", "Cuculiformes", "Cuculidae"),
    campos: {
      reino: "Animalia", grupo: "Ave", simetria: "Bilateral",
      reproducao: "Ovíparo", fecundacao: "Interna", desenvolvimento: "Direto",
      habitat: "Aéreo", dieta: "Carnívoro", zoonose: "Não", relevancia: "Silvestre",
      termorregulacao: "Endotérmico", revestimento: "Penas", respiracao: "Pulmonar",
      esqueleto: "Endoesqueleto ósseo", excrecao: "Uricotélico",
      conservacao: "LC", massaKg: 0.1,
    },
  },
  {
    id: "cardeal-nordeste",
    nomeComum: "Cardeal-do-nordeste",
    nomeCientifico: "Paroaria dominicana",
    emoji: "🐦",
    revisado: true,
    taxonomia: tax("Chordata", "Aves", "Passeriformes", "Thraupidae"),
    campos: {
      reino: "Animalia", grupo: "Ave", simetria: "Bilateral",
      reproducao: "Ovíparo", fecundacao: "Interna", desenvolvimento: "Direto",
      habitat: "Aéreo", dieta: "Onívoro", zoonose: "Não", relevancia: "Silvestre",
      termorregulacao: "Endotérmico", revestimento: "Penas", respiracao: "Pulmonar",
      esqueleto: "Endoesqueleto ósseo", excrecao: "Uricotélico",
      conservacao: "LC", massaKg: 0.04,
    },
  },
  {
    ...
    emoji: "🦅",
    revisado: true,
    taxonomia: tax("Chordata", "Aves", "Accipitriformes", "Accipitridae"),
    campos: {
      reino: "Animalia", grupo: "Ave", simetria: "Bilateral",
      reproducao: "Ovíparo", fecundacao: "Interna", desenvolvimento: "Direto",
      habitat: "Aéreo", dieta: "Carnívoro", zoonose: "Não", relevancia: "Silvestre",
      termorregulacao: "Endotérmico", revestimento: "Penas", respiracao: "Pulmonar",
      esqueleto: "Endoesqueleto ósseo", excrecao: "Uricotélico",
      conservacao: "VU", massaKg: 6,
    },
  },
  {
    id: "coruja-buraqueira",
    nomeComum: "Coruja-buraqueira",
    nomeCientifico: "Athene cunicularia",
    emoji: "🦉",
    revisado: true,
    taxonomia: tax("Chordata", "Aves", "Strigiformes", "Strigidae"),
    campos: {
      reino: "Animalia", grupo: "Ave", simetria: "Bilateral",
      reproducao: "Ovíparo", fecundacao: "Interna", desenvolvimento: "Direto",
      habitat: "Terrestre", dieta: "Carnívoro", zoonose: "Não", relevancia: "Silvestre",
      termorregulacao: "Endotérmico", revestimento: "Penas", respiracao: "Pulmonar",
      esqueleto: "Endoesqueleto ósseo", excrecao: "Uricotélico",
      conservacao: "LC", massaKg: 0.15,
    },
  },
  {
    id: "poraque",
    nomeComum: "Poraquê (peixe-elétrico)",
    nomeCientifico: "Electrophorus electricus",
    emoji: "🐟",
    revisado: true,
    taxonomia: tax("Chordata", "Actinopterygii", "Gymnotiformes", "Gymnotidae"),
    campos: {
      reino: "Animalia", grupo: "Peixe ósseo", simetria: "Bilateral",
      reproducao: "Ovíparo", fecundacao: "Externa", desenvolvimento: "Direto",
      habitat: "Aquático (dulcícola)", dieta: "Carnívoro", zoonose: "Não", relevancia: "Silvestre",
      // O poraquê não possui escamas (pele nua).
      termorregulacao: "Ectotérmico", revestimento: "Pele nua", respiracao: "Branquial",
      esqueleto: "Endoesqueleto ósseo", excrecao: "Amoniotélico",
      conservacao: "LC", massaKg: 20,
    },
  },
  {
    id: "porquinho-da-india",
    nomeComum: "Porquinho-da-índia",
    nomeCientifico: "Cavia porcellus",
    emoji: "🐹",
    revisado: true,
    taxonomia: tax("Chordata", "Mammalia", "Rodentia", "Caviidae"),
    campos: {
      reino: "Animalia", grupo: "Mamífero", simetria: "Bilateral",
      reproducao: "Vivíparo", fecundacao: "Interna", desenvolvimento: "Direto",
      habitat: "Terrestre", dieta: "Herbívoro", zoonose: "Não", relevancia: "Pet",
      termorregulacao: "Endotérmico", revestimento: "Pelos", respiracao: "Pulmonar",
      esqueleto: "Endoesqueleto ósseo", excrecao: "Ureotélico",
      conservacao: null, massaKg: 1,
    },
  },
  {
    id: "gecko-leopardo",
    nomeComum: "Gecko-leopardo",
    nomeCientifico: "Eublepharis macularius",
    emoji: "🦎",
    revisado: true,
    taxonomia: tax("Chordata", "Reptilia", "Squamata", "Eublepharidae"),
    campos: {
      reino: "Animalia", grupo: "Réptil", simetria: "Bilateral",
      reproducao: "Ovíparo", fecundacao: "Interna", desenvolvimento: "Direto",
      habitat: "Terrestre", dieta: "Carnívoro", zoonose: "Não", relevancia: "Pet",
      termorregulacao: "Ectotérmico", revestimento: "Escamas", respiracao: "Pulmonar",
      esqueleto: "Endoesqueleto ósseo", excrecao: "Uricotélico",
      conservacao: null, massaKg: 0.06,
    },
  },
  {
    id: "hedgehog",
    nomeComum: "Ouriço-africano (hedgehog)",
    nomeCientifico: "Atelerix albiventris",
    emoji: "🦔",
    revisado: true,
    taxonomia: tax("Chordata", "Mammalia", "Eulipotyphla", "Erinaceidae"),
    campos: {
      reino: "Animalia", grupo: "Mamífero", simetria: "Bilateral",
      reproducao: "Vivíparo", fecundacao: "Interna", desenvolvimento: "Direto",
      habitat: "Terrestre", dieta: "Onívoro", zoonose: "Não", relevancia: "Pet",
      // Os espinhos são pelos modificados.
      termorregulacao: "Endotérmico", revestimento: "Pelos", respiracao: "Pulmonar",
      esqueleto: "Endoesqueleto ósseo", excrecao: "Ureotélico",
      conservacao: null, massaKg: 0.4,
    },
  },
  {
    id: "lontra",
    nomeComum: "Lontra-neotropical",
    nomeCientifico: "Lontra longicaudis",
    emoji: "🦦",
    revisado: true,
    taxonomia: tax("Chordata", "Mammalia", "Carnivora", "Mustelidae"),
    campos: {
      reino: "Animalia", grupo: "Mamífero", simetria: "Bilateral",
      reproducao: "Vivíparo", fecundacao: "Interna", desenvolvimento: "Direto",
      habitat: "Aquático (dulcícola)", dieta: "Carnívoro", zoonose: "Não", relevancia: "Silvestre",
  ...
  },
  {
    ...
    campos: {
      ...
      termorregulacao: "Endotérmico", revestimento: "Pelos", respiracao: "Pulmonar",
      esqueleto: "Endoesqueleto ósseo", excrecao: "Ureotélico",
      conservacao: "EN", massaKg: 26,
    },
  },

  // ===========================================================================
  // Adições (revisadas via busca web): aves, primatas, canídeos e cestódeo
  // ===========================================================================
  {
    id: "urutau",
    nomeComum: "Urutau",
    ...
    emoji: "🐦",
    revisado: true,
    taxonomia: tax("Chordata", "Aves", "Caprimulgiformes", "Nyctibiidae"),
    campos: {
      reino: "Animalia", grupo: "Ave", simetria: "Bilateral",
      reproducao: "Ovíparo", fecundacao: "Interna", desenvolvimento: "Direto",
      habitat: "Aéreo", dieta: "Carnívoro", zoonose: "Não", relevancia: "Silvestre",
  ...
  },
  {
    ...
    emoji: "🦜",
    revisado: true,
    taxonomia: tax("Chordata", "Aves", "Piciformes", "Ramphastidae"),
    campos: {
      reino: "Animalia", grupo: "Ave", simetria: "Bilateral",
      reproducao: "Ovíparo", fecundacao: "Interna", desenvolvimento: "Direto",
      habitat: "Aéreo", dieta: "Onívoro", zoonose: "Não", relevancia: "Silvestre",
      termorregulacao: "Endotérmico", revestimento: "Penas", respiracao: "Pulmonar",
      esqueleto: "Endoesqueleto ósseo", excrecao: "Uricotélico",
      conservacao: "LC", massaKg: 0.6,
    },
  },
  {
    id: "ararinha-azul",
    nomeComum: "Ararinha-azul",
    ...
    campos: {
      ...
      termorregulacao: "Endotérmico", revestimento: "Penas", respiracao: "Pulmonar",
      esqueleto: "Endoesqueleto ósseo", excrecao: "Uricotélico",
      // Extinta na natureza (EW) — reintroduções em curso.
      conservacao: "EW", massaKg: 0.3,
    },
  },
  {
    id: "sagui-tufo-preto",
    nomeComum: "Sagui-de-tufo-preto",
    nomeCientifico: "Callithrix penicillata",
    emoji: "🐒",
    revisado: true,
    taxonomia: tax("Chordata", "Mammalia", "Primates", "Callitrichidae"),
    campos: {
      reino: "Animalia", grupo: "Mamífero", simetria: "Bilateral",
      reproducao: "Vivíparo", fecundacao: "Interna", desenvolvimento: "Direto",
      habitat: "Terrestre", dieta: "Onívoro", zoonose: "Não", relevancia: "Silvestre",
      termorregulacao: "Endotérmico", revestimento: "Pelos", respiracao: "Pulmonar",
      esqueleto: "Endoesqueleto ósseo", excrecao: "Ureotélico",
      conservacao: "LC", massaKg: 0.35,
    },
  },
  {
    id: "mico-leao-dourado",
    nomeComum: "Mico-leão-dourado",
    ...
    campos: {
      ...
      termorregulacao: "Endotérmico", revestimento: "Pelos", respiracao: "Pulmonar",
      esqueleto: "Endoesqueleto ósseo", excrecao: "Ureotélico",
      conservacao: "EN", massaKg: 0.6,
    },
  },
  {
    id: "cachorro-vinagre",
    nomeComum: "Cachorro-vinagre",
    ...
    campos: {
      ...
      termorregulacao: "Endotérmico", revestimento: "Pelos", respiracao: "Pulmonar",
      esqueleto: "Endoesqueleto ósseo", excrecao: "Ureotélico",
      conservacao: "NT", massaKg: 6,
    },
  },
  {
    id: "cachorro-do-mato",
    nomeComum: "Cachorro-do-mato",
    ...
    campos: {
      ...
      termorregulacao: "Endotérmico", revestimento: "Pelos", respiracao: "Pulmonar",
      esqueleto: "Endoesqueleto ósseo", excrecao: "Ureotélico",
      conservacao: "LC", massaKg: 6,
    },
  },
  {
    id: "tenia-solitaria",
    nomeComum: "Tênia-solitária",
    nomeCientifico: "Taenia solium",
    emoji: "🪱",
    revisado: true,
    taxonomia: tax("Platyhelminthes", "Cestoda", "Cyclophyllidea", "Taeniidae"),
    campos: {
      reino: "Animalia", grupo: "Cestódeo", simetria: "Bilateral",
      reproducao: "Ovíparo", fecundacao: "Interna", desenvolvimento: "Indireto",
      habitat: "Parasitário", dieta: "Parasita", zoonose: "Sim", relevancia: "Parasita",
